          ...
          <CardContent className="text-left space-y-6 relative">
            ...
            <div className="relative z-10">
              <div className="space-y-2" style={{ 
                ...
                <p><strong>Materi:</strong> Orientasi dan Persiapan Program</p>
                <p><strong>Waktu:</strong> 08.00 - 16.00 WIB</p>
                <p><strong>Ruangan:</strong> Aula Utama</p>
              </div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <ul className="list-disc pl-5 space-y-2" style={{ 
                ...
                <li>Alat Tulis dan Buku Catatan</li>
                <li>Pakaian Nyaman dan Sopan</li>
                <li>Form Pendaftaran yang sudah diisi</li>
                <li>Botol Minum dan Snack</li>
              </ul>
            </div>
          </CardContent>
        </Card>
